...
public class Ejercicio_12_18_AddPackageStatement {
    public static void main(String[] args) throws Exception {


        //PATH: C:\Users\juan\IdeaProjects\EjercicioCAP12\src
        if (args.length != 1) {
            System.out.println("Usage: java Ejercicio_12_18_AddPackageStatement srcRootDirectory");
            System.exit(1);
        }
